...
* https://github.com/weimingtom/asr_android_hello  
...
* (IMP) search aiuidemo_v1.rar, 讯飞平台AIUI WebAPI调用Java工程, see below : Xunfei (iflytek) WebAPI v2    
...
see https://github.com/bsatrom/tf-speech-particle, run example 10s voice with some problems    
* (TODO) ***Python机器学习, book, 高斯混合模型的Python实现代码***  
* (TODO) ***Python深度学习实战 基于TensorFlow和Keras的聊天机器人以及人脸 物体和语音识别, book, see below***  
...
from https://github.com/boochow/TFLite_Micro_MicroSpeech_M5Stack  
* micro_speech_v5_tf211_lib.zip  
from https://github.com/tanakamasayuki/Arduino_TensorFlowLite_ESP32  
