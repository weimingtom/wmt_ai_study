...
E:\work\work_git\pv3d\misaki-master\tgui  
...
* minigui  
search badiupan, MinGUI162.rar  
* qt  
search baidupan, qt-x11-free-3.0.3.tar.gz  
* LittlevGL, LVGL  
...
* (TODO) search baidupan, UCGUI3.90_Source.zip  
...
## qt  
see https://github.com/weimingtom/wmt_ai_study/blob/master/qt_001.md  

## nw.js  
https://github.com/weimingtom/mang/tree/wmt  

## (单片机）freedom-platform  
https://sourceforge.net/projects/freedom-platform/  

## stemwin  

## QWS的全称是Qt windows system  
https://blog.51cto.com/countryfrog/843526  

## dotnet GUI, C# GUI  
https://gitee.com/yhuse/SunnyUI  
https://dotnet9.com/4177.html  
https://github.com/kwwwvagaa/NetWinformControl  
dotnetbar， mui， DSOFRAMER， devexpress  
search weibo, winform  

## MGL2, for NEC PDA  
http://www.at.sakura.ne.jp/~suz/MGL2/index.html  
search mgl2-alpha-020.tar.gz  

## qt, xorg, x11, gtk+2  
* search baidupan, 嵌入式Linux应用开发完全手册, 光盘, 基于2440      

## microwindows  
* https://github.com/ghaerr/microwindows  

## LVGL-8.2 demo, 2K0300先锋派    
* lvgl-8.2-src.tar.gz
* https://gitee.com/open-loongarch/docs-2k0300/blob/master/2K0300先锋派/quick_start.md  
```
用virtualbox和archlinux 2025的最小模式
framebuffer编译运行LVGL-8.2 demo
（来源于龙芯2K0300先锋派资料）的效果（鼠标不起作用，
需要framebuffer，archinstall安装profile为最小模式）。
之前我好像说错了，我以为fedora里面的最小模式是可以用framebuffer的，
